...
$alipay_config['partner']		= '2088221163169650';
...
$alipay_config['notify_url'] = 'http://'.$_SERVER['HTTP_HOST']."/Pay/alipayCallback/";

// 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
//$alipay_config['return_url'] = "http://商户网址/create_direct_pay_by_user-PHP-UTF-8/return_url.php";
$alipay_config['return_url'] = 'http://'.$_SERVER['HTTP_HOST']."/Pay/alipayReturn/";
