...
use Common\Pay\ThirdPay\yeepayCrypt_AES;
use Common\Pay\ThirdPay\yeepayCrypt_RSA;
use Common\Pay\ThirdPay\yeepay\yeepayMPayException;
...
//		for api : query/order
	...
	protected function parseReturn($data,$encryptkey){
		...
		if(!array_key_exists('sign', $return)){
			...
			//	throw throw new yeepayMPayException('请求返回签名验证失败',1002);
